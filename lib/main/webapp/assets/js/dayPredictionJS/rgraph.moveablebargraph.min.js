...
(function (win, doc, undefined) {
    ...
    RG.Background.draw = RG.background.draw = RG.background.Draw = function (obj) {
        ...
        //
        var func = function func(obj, cacheCanvas, cacheContext) {
            ...
            for (var i = 0, len = labels_processed.length; i < len; i += 1) {
                if (labels_processed[i]) {
                    ...
                    if (coords && coords.length > 0) {
                        ...
                        // Fore ground color
                        co.fillStyle = _typeof(labels_processed[i]) === 'object' && typeof labels_processed[i][1] === 'string' ? labels_processed[i][1] : 'black';
                        ...
                        RG.text2(obj, {
                            ...
                            'text': _typeof(labels_processed[i]) === 'object' && typeof labels_processed[i][0] === 'string' ? labels_processed[i][0] : labels_processed[i],
                            'valign': 'bottom',
                            'halign': 'center',
                            'bounding': true,
                            'bounding.fill': _typeof(labels_processed[i]) === 'object' && typeof labels_processed[i][2] === 'string' ? labels_processed[i][2] : 'white',
                            'tag': 'labels ingraph'
                        });
                        co.fill();
                    }
    ...
    RG.fireCustomEvent = RG.FireCustomEvent = function (obj, name) {
        if (obj && obj.isRGraph) {
            ...
            if (typeof uid === 'string' && _typeof(RG.events) === 'object' && _typeof(RG.events[uid]) === 'object' && RG.events[uid].length > 0) {
    ...
    RG.hasTooltips = function (obj) {
        ...
        if (_typeof(prop['chart.tooltips']) == 'object' && prop['chart.tooltips']) {
    ...
    RG.OR.clear = RG.OR.Clear = function () {
        ...
        if (arguments[0]) {
            var id = _typeof(arguments[0]) === 'object' ? arguments[0].id : arguments[0];
    ...
    RG.pr = function (obj) {
        ...
        switch (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) {
            ...
            case 'string':
                str += obj + ' (' + (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) + ', ' + obj.length + ')';break;
            case 'number':
                str += obj + ' (' + (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) + ')';break;
            case 'boolean':
                str += obj + ' (' + (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) + ')';break;
            case 'function':
                str += 'function () {}';break;
            ...
            default:
                str += 'Unknown type: ' + (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) + '';
                break;
        }
    ...
    RG.measureText = RG.MeasureText = function (text, bold, font, size) {
        ...
        if (_typeof(RG.measuretext_cache) == 'object' && RG.measuretext_cache[str]) {
    ...
    RG.hidePalette = RG.HidePalette = function () {
        ...
        if ((typeof div === 'undefined' ? 'undefined' : _typeof(div)) == 'object' && div) {
                ...
                if (objects && objects.length > 0) {
                    ...
                    for (var i = 0, len = objects.length; i < len; i += 1) {
                        ...
                        if (shape) {
                            ...
                            if (_typeof(obj['$' + index]) == 'object' && typeof obj['$' + index].onmousemove == 'function') {
                        ...
                        if (shape && (typeof func == 'function' || typeof func2 == 'function' || typeof obj.Get('link') === 'string')) {
                            ...
                            // event listeners
                            if (_typeof(RG.events) === 'object' && _typeof(RG.events[obj.uid]) === 'object') {
                        ...
                        if (shape) {
                            ...
                            if (_typeof(obj['$' + index]) == 'object' && typeof obj['$' + index].onmouseover == 'function') {
...
RGraph.Bar = function (conf) {
    ...
    this.draw = this.Draw = function () {
         ...
         * with pyramid charts
         */
        if ((prop['chart.variant'] == 'pyramid' || prop['chart.variant'] == 'dot') && _typeof(prop['chart.tooltips']) == 'object' && prop['chart.tooltips'] && prop['chart.tooltips'].length > 0) {
        ...
        if (prop['chart.xaxispos'] == 'center') {
            ...
            if (this.scale2.min != 0 || prop['chart.scale.zerostart']) {
                ...
                RG.Text2(this, (_RG$Text = {
                    ...
                    'valign': 'center'
                }, _defineProperty(_RG$Text, 'valign', 'center'), _defineProperty(_RG$Text, 'halign', align), _defineProperty(_RG$Text, 'bordered', boxed), _defineProperty(_RG$Text, 'tag', 'scale'), _RG$Text));
            }
        }
    };
            ...
            for (var i = 0, len = data.length, sequentialIndex = 0; i < len; i += 1) {
                ...
                if (typeof data[i] === 'number' && data[i] >= 0) {
                    ...
                    RG.text2(this, {
                        ...
                        'text': specific ? specific[sequentialIndex] || '' : RG.numberFormat(this, Number(_typeof(data[i]) === 'object' ? data[i][0] : data[i]).toFixed(decimals), unitsPre, unitsPost),
                        'halign': halign,
                        'valign': valign,
                        'angle': angle,
                        'marker': false,
    ...
    this.wave = function () {
        ...
        for (var i = 0, len = obj.data.length; i < len; i += 1) {
            ...
            if (_typeof(obj.data[i]) === 'object' && obj.data[i]) {
                opt.counters[i] = [];
